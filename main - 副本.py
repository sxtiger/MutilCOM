...
class MultiSerialMonitor(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("多串口通信程序V1.1")
    ...
    def send_data(self, port, send_line):
        data = send_line.text()
        if data:
    ...
    def add_port_widgets(self, port):
        ...
        send_button.clicked.connect(lambda checked, p=port, l=send_line: self.send_data(p, l))
        ...
        send_layout.addWidget(send_line)
        ...
        self.send_lines[port] = send_line
